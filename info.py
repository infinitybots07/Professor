...
#---------------Verification------------------------
VERIFICATION_CHANNEL = environ.get("VERIFICATION_CHANNEL", "-1002043202934")
...
LANGUAGES = ["bengali", "ben", "hindi", "hin", "tamil", "tam", "telugu", "tel", "english", "eng", "kannada", "kan", "malayalam", "mal"]
